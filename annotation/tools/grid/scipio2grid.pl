...
Chunk input data to run multiple scipio jobs in parallel using Grid

=head1 SYNOPSIS

    gaas_scipiogrid.pl --genome genome.fasta --protein protein.fasta -o outdir
    gaas_scipiogrid.pl --help
