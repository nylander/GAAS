...
our $VERSION     = 1.00;
our @ISA         = qw(Exporter);
our @EXPORT_OK   = qw(execute_R_command rcc_density_one_row_per_file rcc_plot_from_list);
our %EXPORT_TAGS = ( DEFAULT => [qw()],
                 Ok    => [qw(execute_R_command rcc_density_one_row_per_file rcc_plot_from_list)]);
=head1 SYNOPSIS
