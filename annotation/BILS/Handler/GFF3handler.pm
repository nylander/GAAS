...
sub complement_omniscients_by_size {
	...
	my $omniscient1_sorted = sort_by_seq_and_strand($omniscient1);
	my $omniscient2_sorted = sort_by_seq_and_strand($omniscient2);
