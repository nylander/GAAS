...
sub check_level1_positions{
	my ($hash_omniscient, $level1_feature)=@_;
	 ...
	 my @values = $level1_feature->get_tag_values('ID');
     my $level1_feature_name = lc(shift @values) ;
